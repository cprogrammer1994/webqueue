...
#define sock_write(a, b, c) send(a, (char *)b, c, 0)
#define sock_read(a, b, c) recv(a, b, c, 0)
#define sock_blocking(a, b) { ULONG x = !b; ioctlsocket(a, FIONBIO, &x); }
#define sock_reuse(a) { int x = 1; setsockopt(a, SOL_SOCKET, SO_REUSEADDR, (char *)&x, sizeof(x)); }
...
#define sock_blocking(a, b) fcntl(a, F_SETFL, b ? fcntl(a, F_GETFL) & ~O_NONBLOCK : fcntl(a, F_GETFL) | O_NONBLOCK)
#define sock_reuse(a) { int x = 1; setsockopt(a, SOL_SOCKET, SO_REUSEADDR, &x, sizeof(x)); }
#define sock_would_block() (errno == EWOULDBLOCK)
#endif
